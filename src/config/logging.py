...
def setup_logging():
    ...
    # Intercept standard logging (used by disnake) into loguru
    ...
    # Enable debug logging for disnake voice components
    for name in ["disnake.voice_client", "disnake.gateway", "disnake.client"]:
